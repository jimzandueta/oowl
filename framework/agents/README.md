...
See `.opencode/prompts/execution/cost-tiering.md` for the three-tier framework, `.opencode/prompts/workflow/routing.md` for default flow and the trivial-fix path, and `.opencode/prompts/execution/implementation-safety.md` for test-first and low-tier routing rules.
